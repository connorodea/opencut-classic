...
FilmFusion is a free, open-source video editor for the browser -- forked
from [OpenCut](https://github.com/opencut-app/opencut).
...
![Star History Chart](https://api.star-history.com/svg?repos=connorodea/opencut-classic&type=Date)
