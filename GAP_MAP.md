...
_Last updated: 2026-08-06 · v0.5_
...
## Gap count
47 registered Actions (30 original + 4 closing Tier 1 + 5 closing effects + 5 closing
keyframes/animation + 3 closing masks). ~38 manager-level mutating methods identified.
~30 now have Action coverage. **~8 methods still have zero Action coverage** — Tier 2's
scene CRUD/tracks/project-library-lifecycle subsystems, plus all of Tier 3.

## Next (1b)
Tier 1 closed. Tier 2's effects, keyframes/animation, and masks subsystems closed.
Continue through Tier 2's remaining subsystems (scene CRUD, tracks, project-library
