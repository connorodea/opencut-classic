...
export function Onboarding() {
	...
	const getStepTitle = () => {
		switch (step) {
			case 0:
				return "Welcome to FilmFusion Beta! 🎉";
			case 1:
				return "⚠️ This is a super early beta!";
			case 2:
				return "🦋 Have fun testing!";
			default:
				return "FilmFusion Onboarding";
		}
	};
				...
				return (
					<div className="space-y-5">
						<div className="space-y-3">
							<Title title="Welcome to FilmFusion Beta! 🎉" />
							<Description description="You're among the first to try FilmFusion, a fully open source video editor." />
						</div>
							...
							<Description
								description={
									SOCIAL_LINKS.discord
										? `Join our [Discord](${SOCIAL_LINKS.discord}), chat with cool people and share feedback to help make FilmFusion the best editor ever.`
										: "Use the feedback button in the app if you run into issues or have ideas -- it helps us make FilmFusion the best editor ever."
								}
							/>
						</div>
