...
export const metadata: Metadata = {
	title: "Changelog - FilmFusion",
	description: "What's new in FilmFusion",
	openGraph: {
		title: "Changelog - FilmFusion",
		description: "Every update, improvement, and fix to FilmFusion — documented.",
		type: "website",
		images: [
			{
...
export default function ChangelogPage() {
	...
	return (
		<BasePage title="Changelog" description="See what's new in FilmFusion">
