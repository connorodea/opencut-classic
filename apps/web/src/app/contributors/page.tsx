...
export const metadata: Metadata = {
	title: "Contributors - FilmFusion",
	description:
		"Meet the amazing people who contribute to FilmFusion, the free and open-source video editor.",
	openGraph: {
		title: "Contributors - FilmFusion",
		description:
			"Meet the amazing people who contribute to FilmFusion, the free and open-source video editor.",
...
async function getContributors(): Promise<Contributor[]> {
	try {
		const response = await fetch(
			"https://api.github.com/repos/FilmFusion-app/FilmFusion/contributors?per_page=100",
			{
				headers: {
					Accept: "application/vnd.github.v3+json",
					"User-Agent": "FilmFusion-Web-App",
				},
...
export default async function ContributorsPage() {
	...
	return (
		<BasePage
			title="Contributors"
			description="Meet the amazing people who contribute to FilmFusion, the free and open-source video editor."
		>
			...
			<div className="mx-auto flex max-w-6xl flex-col gap-20">
				...
				<GitHubContributeSection
					...
					description="FilmFusion is built by developers like you. Every contribution, no matter how small, helps make video editing more accessible for everyone."
				/>
			</div>
		</BasePage>
	);
	...
	return (
		<div className="flex flex-col gap-12">
			<div className="flex flex-col gap-2 text-center">
				...
				<p className="text-muted-foreground">
					Everyone who makes FilmFusion better
				</p>
			</div>
	...
	return (
		<div className="flex flex-col gap-10">
			<div className="flex flex-col gap-2 text-center">
				...
				<p className="text-muted-foreground">Tools we use to build FilmFusion</p>
			</div>
