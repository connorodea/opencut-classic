...
const roadmapItems: RoadmapItem[] = [
	...
	},
	{
		...
		description:
			"Native FilmFusion apps for Mac, Windows, Linux, and iOS/Android.",
		status: {
			text: "Not started",
			type: "default",
		},
...
export const metadata: Metadata = {
	title: "Roadmap - FilmFusion",
	description:
		"See what's coming next for FilmFusion - the free, open-source video editor that respects your privacy.",
	openGraph: {
		title: "FilmFusion Roadmap - What's Coming Next",
		description:
			"See what's coming next for FilmFusion - the free, open-source video editor that respects your privacy.",
		type: "website",
		images: [
...
export default function RoadmapPage() {
	return (
		<BasePage
			title="Roadmap"
			description={`What's coming next for FilmFusion (last updated: ${LAST_UPDATED})`}
		>
			<div className="mx-auto flex max-w-4xl flex-col gap-16">
				...
				<GitHubContributeSection
					title="Want to help?"
					description="FilmFusion is open source and built by the community. Every contribution,
