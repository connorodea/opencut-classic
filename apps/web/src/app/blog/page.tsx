...
export const metadata: Metadata = {
	title: "Blog - FilmFusion",
	description:
		"Read the latest news and updates about FilmFusion, the free and open-source video editor.",
	openGraph: {
		title: "Blog - FilmFusion",
		description:
			"Read the latest news and updates about FilmFusion, the free and open-source video editor.",
...
export default async function BlogPage() {
	...
	return (
		<BasePage
			title="Blog"
			description="Read the latest news and updates about FilmFusion, the free and open-source video editor."
		>
